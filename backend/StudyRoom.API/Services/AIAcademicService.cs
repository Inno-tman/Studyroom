...
public class AIAcademicService : IAIAcademicService
{
    ...
    private static (string System, string User) BuildFlashcardPrompt(string content, int count, string? focus)
    {
        ...
        var system = $"""
You are an expert flashcard creator for a study app called Study Crib. You turn study material into clear, focused flashcards.
Rules:
...
""";
    ...
    private static (string System, string User) BuildGamePrompt(GameContentRequestDto request, string game)
    {
        ...
        var system = $"""
You are an educational content generator for a study app called Study Crib. You create short, accurate, age-appropriate quiz material.
Rules:
...
""";
    ...
    private async Task<AcademicResponseDto> HandleGeneralQuery(AcademicQueryDto query)
    {
        ...
        var systemPrompt = $"""
You are an academic tutor AI in a collaborative study platform called Study Crib. 
...
""";
    ...
    private async Task<AcademicResponseDto> HandleResearchQuery(AcademicQueryDto query)
    {
        ...
        var systemPrompt = $"""
You are an academic research assistant AI in Study Crib. Your role is to help users conduct academic research using proper research methodology.
...
""";
    ...
    private static string GenerateFallbackResponse(string question, string? subject)
    {
        ...
        if (q.Contains("hello") || q.Contains("hi ") || q == "hi")
            return "Hello! I'm your Study Crib academic assistant. What subject are you studying today? I can help with math, science, programming, and more.";
